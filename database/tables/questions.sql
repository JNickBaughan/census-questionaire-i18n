CREATE TABLE [dbo].[Questions](
    ...
    ,[answerTypeId]             [INT]           NOT NULL FOREIGN KEY REFERENCES [AnswerTypes](answerTypeId) --used by the ui for type of control - select, multi-select, freeform, multipart-freeform
